...
/**
 * Controller class to process the Delete User call
 * 
 * @author Desktopadmin
 *
 */
@Path("/deleteUser")
public class UserRepositoryAPIDeleteUserController implements UserRepositoryAPIConstants {
	@POST
	...
	public UserRepositoryAPIOutputVO updateUser(UserRepositoryAPIInputVo userRepositoryAPIInputVo){
		...
		userRepositoryAPIOutputVO = UserRepositoryAPIValidationHelper.processResponse(userRepositoryAPIInputVo, CHANNEL_DELETE);
